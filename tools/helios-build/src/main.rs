...
const DATE_FORMAT_STR: &str = "[year]-[month]-[day]";
const TIME_FORMAT_STR: &str = "[hour]:[minute]:[second]";
...
fn ncpus() -> Result<u32> {
    ...
    stdout.trim().parse().context("psrinfo parse failure")
}
